...
export function LoginForm({ onToggleForm, onForgotPassword }: LoginFormProps) {
  ...
  const handleSocialLogin = (provider: string) => {
    ...
    // Aqui seria a lógica de login social
  };
  ...
  return (
    <Card className="w-full max-w-md mx-auto bg-glass/50 backdrop-blur-xl border-glass-border shadow-2xl">
      ...
      <CardContent className="space-y-4">
        ...
        <Button
          variant="outline"
          className="w-full bg-white hover:bg-gray-50 text-gray-900 border-glass-border transition-colors"
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Button
                type="button"
                variant="link"
                className="p-0 h-auto text-xs text-primary hover:text-accent transition-colors"
